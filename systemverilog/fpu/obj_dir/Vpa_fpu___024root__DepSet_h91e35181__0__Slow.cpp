...
VL_ATTR_COLD void Vpa_fpu___024root___eval_static(Vpa_fpu___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vpa_fpu___024root___eval_static\n"); );
...
VL_ATTR_COLD void Vpa_fpu___024root___eval_initial(Vpa_fpu___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vpa_fpu___024root___eval_initial\n"); );
    Vpa_fpu__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
}

VL_ATTR_COLD void Vpa_fpu___024root___eval_final(Vpa_fpu___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vpa_fpu___024root___eval_final\n"); );
    Vpa_fpu__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
}
...
#endif  // VL_DEBUG
VL_ATTR_COLD bool Vpa_fpu___024root___eval_phase__stl(Vpa_fpu___024root* vlSelf);

VL_ATTR_COLD void Vpa_fpu___024root___eval_settle(Vpa_fpu___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vpa_fpu___024root___eval_settle\n"); );
    Vpa_fpu__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
...
#endif
            VL_FATAL_MT("fpu_top.sv", 70, "", "Settle region did not converge.");
        }
        __VstlIterCount = ((IData)(1U) + __VstlIterCount);
        __VstlContinue = 0U;
        if (Vpa_fpu___024root___eval_phase__stl(vlSelf)) {
            __VstlContinue = 1U;
        }
...
#ifdef VL_DEBUG
VL_ATTR_COLD void Vpa_fpu___024root___dump_triggers__stl(Vpa_fpu___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vpa_fpu___024root___dump_triggers__stl\n"); );
    Vpa_fpu__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void Vpa_fpu___024root___stl_sequent__TOP__0(Vpa_fpu___024root* vlSelf);

VL_ATTR_COLD void Vpa_fpu___024root___eval_stl(Vpa_fpu___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vpa_fpu___024root___eval_stl\n"); );
    Vpa_fpu__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    if ((1ULL & vlSelfRef.__VstlTriggered.word(0U))) {
        Vpa_fpu___024root___stl_sequent__TOP__0(vlSelf);
    }
}
...
VL_ATTR_COLD void Vpa_fpu___024root___stl_sequent__TOP__0(Vpa_fpu___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vpa_fpu___024root___stl_sequent__TOP__0\n"); );
    Vpa_fpu__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
...
VL_ATTR_COLD bool Vpa_fpu___024root___eval_phase__stl(Vpa_fpu___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vpa_fpu___024root___eval_phase__stl\n"); );
    Vpa_fpu__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
    CData/*0:0*/ __VstlExecute;
    // Body
    Vpa_fpu___024root___eval_triggers__stl(vlSelf);
    __VstlExecute = vlSelfRef.__VstlTriggered.any();
    if (__VstlExecute) {
        Vpa_fpu___024root___eval_stl(vlSelf);
    }
...
VL_ATTR_COLD void Vpa_fpu___024root___dump_triggers__ico(Vpa_fpu___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vpa_fpu___024root___dump_triggers__ico\n"); );
    Vpa_fpu__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void Vpa_fpu___024root___dump_triggers__act(Vpa_fpu___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vpa_fpu___024root___dump_triggers__act\n"); );
    Vpa_fpu__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    ...
    if ((1ULL & vlSelfRef.__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 0 is active: @(posedge arst)\n");
    }
...
VL_ATTR_COLD void Vpa_fpu___024root___dump_triggers__nba(Vpa_fpu___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vpa_fpu___024root___dump_triggers__nba\n"); );
    Vpa_fpu__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    ...
    if ((1ULL & vlSelfRef.__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 0 is active: @(posedge arst)\n");
    }
...
VL_ATTR_COLD void Vpa_fpu___024root___ctor_var_reset(Vpa_fpu___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vpa_fpu___024root___ctor_var_reset\n"); );
    Vpa_fpu__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelf->arst = VL_RAND_RESET_I(1);
    vlSelf->clk = VL_RAND_RESET_I(1);
    vlSelf->a_operand = VL_RAND_RESET_I(32);
    vlSelf->b_operand = VL_RAND_RESET_I(32);
    vlSelf->operation = VL_RAND_RESET_I(4);
    vlSelf->start = VL_RAND_RESET_I(1);
    vlSelf->ieee_packet_out = VL_RAND_RESET_I(32);
    vlSelf->cmd_end = VL_RAND_RESET_I(1);
    vlSelf->busy = VL_RAND_RESET_I(1);
    vlSelf->fpu__DOT__a_mantissa = VL_RAND_RESET_I(26);
    vlSelf->fpu__DOT__a_mantissa_adjusted = VL_RAND_RESET_I(26);
    vlSelf->fpu__DOT__a_exp = VL_RAND_RESET_I(8);
    vlSelf->fpu__DOT__a_exp_adjusted = VL_RAND_RESET_I(8);
    vlSelf->fpu__DOT__a_sign = VL_RAND_RESET_I(1);
    vlSelf->fpu__DOT__b_mantissa = VL_RAND_RESET_I(26);
    vlSelf->fpu__DOT__b_mantissa_adjusted = VL_RAND_RESET_I(26);
    vlSelf->fpu__DOT__b_exp = VL_RAND_RESET_I(8);
    vlSelf->fpu__DOT__b_sign = VL_RAND_RESET_I(1);
    vlSelf->fpu__DOT__result_m_addsub_prenorm = VL_RAND_RESET_I(26);
    vlSelf->fpu__DOT__result_m_addsub_norm = VL_RAND_RESET_I(26);
    vlSelf->fpu__DOT__result_e_addsub_norm = VL_RAND_RESET_I(8);
    vlSelf->fpu__DOT__product_rounded = VL_RAND_RESET_Q(49);
    vlSelf->fpu__DOT__div_quotient_prenorm_out = VL_RAND_RESET_I(24);
    vlSelf->fpu__DOT__zcount_div = VL_RAND_RESET_I(5);
    vlSelf->fpu__DOT__result_exp_div = VL_RAND_RESET_I(8);
    vlSelf->fpu__DOT__result_sign_div = VL_RAND_RESET_I(1);
    vlSelf->fpu__DOT__sqrt_xn_mantissa = VL_RAND_RESET_I(24);
    vlSelf->fpu__DOT__sqrt_xn_exp = VL_RAND_RESET_I(8);
    vlSelf->fpu__DOT__sqrt_xn_sign = VL_RAND_RESET_I(1);
    vlSelf->fpu__DOT__sqrt_A_mantissa = VL_RAND_RESET_I(24);
    vlSelf->fpu__DOT__sqrt_A_exp = VL_RAND_RESET_I(8);
    vlSelf->fpu__DOT__sqrt_A_sign = VL_RAND_RESET_I(1);
    vlSelf->fpu__DOT__sqrt_counter = VL_RAND_RESET_I(4);
    vlSelf->fpu__DOT__start_operation_sqrt_fsm = VL_RAND_RESET_I(1);
    vlSelf->fpu__DOT__operation_done_sqrt_fsm = VL_RAND_RESET_I(1);
    vlSelf->fpu__DOT__sqrt_xn_A_wrt = VL_RAND_RESET_I(1);
    vlSelf->fpu__DOT__sqrt_xn_a_approx_wrt = VL_RAND_RESET_I(1);
    vlSelf->fpu__DOT__sqrt_xn_a_wrt = VL_RAND_RESET_I(1);
    vlSelf->fpu__DOT__sqrt_xn_add_wrt = VL_RAND_RESET_I(1);
    vlSelf->fpu__DOT__sqrt_A_a_wrt = VL_RAND_RESET_I(1);
    vlSelf->fpu__DOT__sqrt_a_xn_wrt = VL_RAND_RESET_I(1);
    vlSelf->fpu__DOT__sqrt_a_A_wrt = VL_RAND_RESET_I(1);
    vlSelf->fpu__DOT__sqrt_b_xn_wrt = VL_RAND_RESET_I(1);
    vlSelf->fpu__DOT__sqrt_b_div_wrt = VL_RAND_RESET_I(1);
    vlSelf->fpu__DOT__result_float2int = VL_RAND_RESET_I(32);
    vlSelf->fpu__DOT__start_operation_ar_fsm = VL_RAND_RESET_I(1);
    vlSelf->fpu__DOT__operation_done_ar_fsm = VL_RAND_RESET_I(1);
    vlSelf->fpu__DOT__log2_prenorm = VL_RAND_RESET_I(31);
    vlSelf->fpu__DOT__log2_abs = VL_RAND_RESET_I(31);
    vlSelf->fpu__DOT__log2_zcount = VL_RAND_RESET_I(6);
    vlSelf->fpu__DOT__curr_state_main_fsm = VL_RAND_RESET_I(4);
    vlSelf->fpu__DOT__next_state_main_fsm = VL_RAND_RESET_I(4);
    vlSelf->fpu__DOT__curr_state_arith_fsm = VL_RAND_RESET_I(4);
    vlSelf->fpu__DOT__next_state_arith_fsm = VL_RAND_RESET_I(4);
    vlSelf->fpu__DOT__curr_state_sqrt_fsm = VL_RAND_RESET_I(4);
    vlSelf->fpu__DOT__next_state_sqrt_fsm = VL_RAND_RESET_I(4);
    vlSelf->fpu__DOT____Vlvbound_hbdf1056a__0 = VL_RAND_RESET_I(1);
    vlSelf->fpu__DOT____VdfgRegularize_hab43e411_0_7 = VL_RAND_RESET_I(32);
    vlSelf->__Vfunc_fpu__DOT__lzc__0__Vfuncout = VL_RAND_RESET_I(6);
    vlSelf->__Vfunc_fpu__DOT__lzc__0__a = VL_RAND_RESET_I(32);
    vlSelf->__Vfunc_fpu__DOT__lzc__1__Vfuncout = VL_RAND_RESET_I(6);
    vlSelf->__Vfunc_fpu__DOT__lzc__1__a = VL_RAND_RESET_I(32);
    vlSelf->__Vfunc_fpu__DOT__lzc__2__Vfuncout = VL_RAND_RESET_I(6);
    vlSelf->__Vfunc_fpu__DOT__lzc__2__a = VL_RAND_RESET_I(32);
    vlSelf->__Vtrigprevexpr___TOP__arst__0 = VL_RAND_RESET_I(1);
